        ...
        <nav class="mt-2">
          <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
            <li class="nav-item menu-open">
              <a href="/accountingdashboard" class="nav-link active">
            ...
            <li class="nav-item">
              <a href="/accountingtabledata" class="nav-link">
    ...
    <div class="content-wrapper">
      ...
      <div class="content-header">
        <div class="container-fluid">
          <div class="row mb-2">
            <div class="col-sm-6">
              {{-- <h1 class="m-0">Accounting Dashboard</h1> --}}
            </div>
          </div>
        </div>
      </div>
